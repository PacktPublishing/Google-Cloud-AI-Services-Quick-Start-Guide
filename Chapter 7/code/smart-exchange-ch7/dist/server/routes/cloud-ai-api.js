...
function defineCloudAIAPIRoutes(app) {
    ...
    router.post('/post-message', auth_1.Authenticate, auth_1.Authorize('user'), cloudAIAPI.postMessage);
    // Translation API
    router.get('/supported-languages', auth_1.Authenticate, auth_1.Authorize('user'), cloudAIAPI.getSupportedLanguages);
    router.post('/translate-message/:target', auth_1.Authenticate, auth_1.Authorize('user'), cloudAIAPI.translateMessage);
